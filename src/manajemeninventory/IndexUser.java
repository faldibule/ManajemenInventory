...
//    private int row;
     ...
     */
    public IndexUser(String nama, int id) {
        initComponents();
        //setting tabel
        data_gudang();data_supplier();data_barang();data_barang_masuk();data_barang_keluar();
        ...
        //disabled combo user di data user
        role_user.setEnabled(false);
    ...
    private void setUserDataById(){
        try{
             Statement statement = (Statement) DB.getConnection().createStatement();
             ResultSet res = statement.executeQuery("SELECT * FROM users WHERE id = '"+this.getId()+"'");
             while(res.next()){
                 nama_user.setText(res.getString("nama"));
                 username_user.setText(res.getString("username"));
                 password_user.setText(res.getString("password"));
                 repeat_user.setText(res.getString("password"));
             }
             res.close(); statement.close();
         }catch(SQLException e){
             JOptionPane.showMessageDialog(rootPane, "Gagal");
...
//    } 
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(4, 115, 90));
        ...
        jButton3.setBackground(new java.awt.Color(4, 115, 90));
        ...
        jButton4.setBackground(new java.awt.Color(4, 115, 90));
        ...
        jButton14.setBackground(new java.awt.Color(4, 115, 90));
        ...
        headPanel.setBackground(new java.awt.Color(0, 153, 153));

        jLabel22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/manajemeninventory/logo.png"))); // NOI18N
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndexUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IndexUser admin = new IndexUser("DEFAULT", 0);
